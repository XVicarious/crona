...
if (sessionCheck()) {
    ...
    $table = '<table id="employees-all" class="bordered centered responsive-table highlight">
                  <thead>
                      <tr>
                          <th data-field="checkbox"><p><input type="checkbox" id="checkall"/><label for="checkall"/></p></th>
    ...
    foreach ($employees as $person) {
        ...
        $table .= "<tr user-id=\"$t_id\"><td>$_checkbox</td><td>$t_id</td><td>$t_adp</td><td>$t_name</td><td>$t_company</td><td>$t_department</td></tr>";
    }
