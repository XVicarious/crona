...
if (sessionCheck()) {
    ...
    $year = $_POST['year'];
    $week = $_POST['week'];
    $scheduleResult = mysqli_query($sqlConnection, "SELECT schedule_day,schedule_in,schedule_out,schedule_department
                                                    FROM employee_schedule WHERE employee_id = $employee AND
                                                    schedule_week = $week AND schedule_year = $year");
    $a_masterSchedule = [];
